...
Model.o:Model.cpp Model.h Cart_Point.h Game_Object.h Oxygen_Depot.h Space_Station.h Person.h Astronaut.h View.h
	$(GCC) -c Model.cpp -o Model.o

Game_Command.o:Game_Command.cpp Game_Command.h Model.h Cart_Point.h Person.h Astronaut.h Oxygen_Depot.h
	$(GCC) -c Game_Command.cpp -o Game_Command.o

View.o:View.cpp View.h Game_Object.h Cart_Point.h
	$(GCC) -c View.cpp -o View.o

main.o:main.cpp Cart_Point.o Cart_Vector.o Game_Object.o Oxygen_Depot.o Space_Station.o Person.o Astronaut.o Model.o Game_Command.o View.o
